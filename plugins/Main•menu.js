...
exp: exp - min,
maxexp: xp,
genre: user.genero == user.genero === 0? 'No especificado' : user.genero == '' ? `${user.genero}` : 'No especificado',
birth: user.birth == user.birth === 0? 'No especificado' : user.birth == '//' ? `${user.birth}` : 'No especificado',
