...
if (user.genre) {
return conn.reply(m.chat, `✨️ Ya tienes un género establecido, si quieres borrar el género actual usa:\n> » ${usedPrefix}delgenre`, m);
}
...
return conn.reply(m.chat, `✨️ Se ha establecido tu género como: *${user.genre}*!`, m);
};
