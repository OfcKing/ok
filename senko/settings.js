...
global.namebot = 'sᥱᥒk᥆ sᥲᥒ - mძ ✰'
global.sessions = 'SanSession'
global.jadi = 'SanJadiBot'

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.packname = 'ᥲі sᥱᥒk᥆ - mძ ✿'
global.botname = 'SenkoBot'
global.wm = 'SenkoBot-MD ❀'
global.author = 'Made By OfcKing 🜲'
global.dev = '© ⍴᥆ᥕᥱrᥱძ ᑲᥡ ᥆𝖿ᥴkіᥒg ✌︎'
global.textbot = 'Senko San ✐'

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.img1 = fs.readFileSync('./icons/Menu.jpg')
global.img2 = fs.readFileSync('./icons/Menu2.jpg')
global.img3 = fs.readFileSync('./icons/Menu3.jpg')
global.catalogo = fs.readFileSync('./icons/catalogo.jpg')

//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*

global.gp1 = 'https://chat.whatsapp.com/GkuIuySiMwb4qJGl3UJtcZ'
...
global.correo = 'thesenkobot@gmail.com'
