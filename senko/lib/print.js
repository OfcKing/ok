...
console.log(`${chalk.red('╭────═[ Senko San - MD ]═─────⋆')}
${chalk.red('│╭───────────────···')}
${chalk.red('││')}👨‍💻 ${chalk.cyan('%s')} ⏱️ ${chalk.black(chalk.bgBlue('%s'))} 📂 ${chalk.black(chalk.bgGreen('%s'))} ${chalk.magenta('%s [%s %sB]')} 
${chalk.yellow('││')}🥷 ${chalk.redBright('%s')} 🏦 ${chalk.yellow('%s%s')} ${chalk.blueBright('en')} 
${chalk.red('││')}💻 ${chalk.cyan('%s')} ${chalk.black(chalk.bgBlue('%s'))}
${chalk.red('│╰────────────────···')}
${chalk.red('╰───────────═┅═──────────')}`.trim(), 
